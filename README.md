...
https://dev.axiomide.com/marketplace/christiangeorgelucas/hdf5-tools@0.1.2
...
```bash
axiom invoke christiangeorgelucas/hdf5-tools/ValidateFile --input '{ ... }'
```

**Call it over HTTP.**

```bash
curl -X POST https://api.axiomide.com/invocations/v1/nodes/christiangeorgelucas/hdf5-tools/0.1.2/ValidateFile \
...
> `axiom inspect node christiangeorgelucas/hdf5-tools/ValidateFile`.
