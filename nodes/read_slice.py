...
def read_slice(ax: AxiomContext, input: ReadSliceRequest) -> ReadSliceResult:
    ...
    CSV requested is a structured INVALID_ARGUMENT error). A dataset_path
    that does not exist, that names a group, or a slice with more
    dimensions than the dataset has returns a structured error rather than
    crashing.
    """
